##The high level data flow of the software is:
...
* **main** a script that puts it all together.
### Secondary
...
### Utilities
* config: for sharing parameters across modules
* set_params: for setting params from the command line
