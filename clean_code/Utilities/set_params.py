...
def set_params():
	...
	parser.add_argument("--percent_size", type=float, default=0.01, help="Percentage size for scatter plot")
	...
	parser.add_argument("--pad_pixels", type=int, default=2, help="The number of pixels to pad if removing clutter")
